...
/**
 * Sheet — accessible off-canvas panel built on @radix-ui/react-dialog.
 *
 * Provides: focus trap, Escape-to-close, ARIA dialog semantics,
 * scroll lock, and focus return to trigger on close.
 *
 * Usage:
  ...
  <SheetPortal>
    ...
    >
      ...
      <DialogPrimitive.Close
        ...
        className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:text-muted-foreground"
      >
