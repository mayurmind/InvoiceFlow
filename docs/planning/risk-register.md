...
| R009 | Supabase/Prisma connection exhaustion                           | Infrastructure | Medium      | Medium   | P3       | Slow API responses                | Supabase-compatible pooled connection strategy                                      | Load testing                                           | Restart connections                                                           | DevOps          | P2           |
...
| R015 | GitHub Actions outage                                           | Infrastructure | High        | Medium   | P3       | CI pipeline stalls                | Understand infrastructure vs project                                                | Wait for recovery                                      | Wait for CI recovery                                                          | DevOps          | P0           |
...
| R018 | Render service/platform availability or backend startup latency | Infrastructure | High        | Low      | P4       | Initial slow API responses        | Approved always-on production tier, health checks, efficient startup and monitoring | Operational monitoring and controlled restart/redeploy | Provider recovery, controlled redeploy, or approved infrastructure escalation | DevOps          | P10          |
